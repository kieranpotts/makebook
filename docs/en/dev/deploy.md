...
3.  Click **Add a provider** and input `virtualbox`.
...
5.  Follow the [SrcFlow workflow](https://srcflow.com/) to update the CHANGELOG and tag a new release in the version control repository. Use the same version number as for the Vagrant Cloud distributable.
